...
public class PostApiControllerTest {
    ...
    @After
    public void tearDown() throws Exception { //initialize
        postsRepository.deleteAll();
    }

    @Test
    public void enroll_Posts() throws Exception {
        //given
    ...
    //test 추가. update 쿼리를 실행하는지 테스트하기 위한 코드
    @Test
    public void Posts_modified_test() throws Exception {
        //given
